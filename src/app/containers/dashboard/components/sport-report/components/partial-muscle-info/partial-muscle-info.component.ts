...
@Component({
  selector: 'app-partial-muscle-info',
  templateUrl: './partial-muscle-info.component.html',
  styleUrls: ['./partial-muscle-info.component.css']
})
export class PartialMuscleInfoComponent implements OnInit, AfterViewInit {
  @ViewChild('partialMuscleInfoChartTarget')
  partialMuscleInfoChartTarget: ElementRef;
  ...
  initHchart() {
    ...
    this.chart1 = chart(this.partialMuscleInfoChartTarget.nativeElement, options);
  }
}
