  ...
  trend: {
    ...
    groupCountsAnalysis: {
      ...
      fieldValue: [
        ...
        [1, 22, 33, 44, 55, 66, 777],
        [3, 22, 33, 66, 99, 100, 1000],
        [5, 18, 32, 48, 60, 120, 888],
        [6, 20, 55, 55, 88, 111, 666],
        [5, 18, 32, 48, 60, 120, 888],
        [6, 20, 55, 55, 88, 111, 666],
        [5, 18, 32, 48, 60, 120, 888],
        [6, 20, 55, 55, 88, 111, 666],
  ...
  trend: {
    ...
    sportsTypeAnalysis: {
      ...
      maleFieldValue: [
        ...
        [777, 888, 999, 666, 555, 444, 333],
        [555, 454, 222, 666, 555, 444, 333],
        [666, 999, 1111, 444, 777, 555, 222],
        [333, 757, 464, 787, 636, 525, 732],
        [666, 999, 1111, 444, 777, 555, 222],
        [333, 757, 464, 787, 636, 525, 732],
        [666, 999, 1111, 444, 777, 555, 222],
        [333, 757, 464, 787, 636, 525, 732],
      ...
      femaleFieldValue: [
        ...
        [777, 888, 999, 666, 555, 444, 333],
        [333, 322, 111, 666, 555, 444, 333],
        [787, 900, 963, 785, 500, 456, 356],
        [320, 300, 200, 554, 468, 777, 424],
        [787, 900, 963, 785, 500, 456, 356],
        [320, 300, 200, 554, 468, 777, 424],
        [787, 900, 963, 785, 500, 456, 356],
        [320, 300, 200, 554, 468, 777, 424],
