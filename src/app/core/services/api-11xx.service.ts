...
export class Api11xxService {
   ...
   * @param body {any}-api 所需參數
   */
  fetchChangeGroupStatus(body: any) {
   ...
   * @param body {any}-api 所需參數
   */
  fetchUpdateJoinStatus(body: any) {
   ...
   * @param body {any}-api 所需參數
   */
  fetchAssignGroupManager(body: any) {
   ...
   * @param body {any}-api 所需參數
   */
  fetchMemberAccessRight(body: any) {
   ...
   * @param body {any}-api 所需參數
   */
  fetchDeleteGroupMember(body: any) {
   ...
   * @param body {any}-api 所需參數
   */
  fetchEditCommerceInfo(body: any) {
   ...
   * @param body {any}-api 所需參數
   */
  fetchFilterSameGroupMember(body: any) {
